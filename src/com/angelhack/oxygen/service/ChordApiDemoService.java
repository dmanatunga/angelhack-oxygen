...
package com.angelhack.oxygen.service;
...
public class ChordApiDemoService extends Service {
    public static String GAME_CHANNEL = "com.angelhack.oxygen.GAMECHANNEL";

    private static final String TAG = "[Oxygen][chord]";
    ...
    public interface IChordServiceListener {
        void onReceiveMessage(String node, String channel, String payloadType, String message);
    ...
    // Initialize chord
    public void initialize(CoreActivity coreActivity) throws Exception {
        if (mChord != null) {
            return;
        }
    ...
    private IChordChannelListener mChannelListener = new IChordChannelListener() {
        ...
        public void onDataReceived(String fromNode, String fromChannel, String payloadType,
            ...
            byte[] buf = payload[0];
            if (null != mListener)
                mListener.onReceiveMessage(fromNode, fromChannel, payloadType, new String(buf));
        }
    ...
    public boolean sendData(String toChannel, String type, byte[] buf, String nodeName) {
        if (mChord == null) {
         ...
         * is returned
         */
        if (false == channel.sendData(nodeName, type, payload)) {
    ...
    public boolean sendDataToAll(String toChannel, String type, byte[] buf) {
        if (mChord == null) {
         ...
         * is returned.
         */
        if (false == channel.sendDataToAll(type, payload)) {
    ...
    public IChordChannel joinChannel(String channelName) {
        ...
        if (channelName == null || channelName.equals("")) {
            ...
            mPrivateChannelName = GAME_CHANNEL;
        } else {
