...
public class BlackDeck {
	...
	public BlackDeck(String stringFromFile){
		blackcards = new ArrayList<BlackCard>();
		String[] phrases = stringFromFile.split("<>");
		
		for(int i = 0; i < phrases.length; i++){
			blackcards.add(new BlackCard(phrases[i]));
		}
	}
	...
	public ArrayList<BlackCard> shuffleDeck(ArrayList<BlackCard> deck){
		ArrayList<BlackCard> shuffledDeck = new ArrayList<BlackCard>();
